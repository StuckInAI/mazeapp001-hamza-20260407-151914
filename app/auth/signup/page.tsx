...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // For demo, we sign in with demo credentials
      const demoEmail = role === 'restaurant' ? 'restaurant@maiz.com' : 'consumer@maiz.com';
  ...
  return (
    <div className="auth-page">
      <div className="auth-container">
        ...
        <p className="auth-subtitle">Join MAIZ and start dining</p>
